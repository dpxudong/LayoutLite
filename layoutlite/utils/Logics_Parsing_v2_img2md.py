...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", type=str, default="/data/code/vlm_ocr_token_test/logics/Alibaba-DT/Logics-Parsing-v2")
    parser.add_argument("--image_path", type=str, default="/data/code/benchmark_validation/OmniDocBenV1.6/dataset/images")
    parser.add_argument("--output_path", type=str, default="/data/code/VL_RL/Logics/md_logics_official")
